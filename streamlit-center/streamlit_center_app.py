...
st.markdown("Configure your new Streamlit project and generate a ready-to-use template.")
...
with st.sidebar:
    ...
    st.metric("Projects Generated", "247")
    st.metric("Active Applications", "34")
    st.metric("Teams Using Standards", "12")
